...
saveas(gcf, '../img/corona_radius_angle.png');

%%
lee_diagram_img = imread('../img/lee_diagram_data_a0001-0021_q000-010.png');
...
box on;
set(gca, 'ylim', [0, 10], 'ydir', 'reverse', 'xlim', [1, 21]/1000, 'xscale', 'log', 'tickdir', 'out', ...
    'fontsize', 12);
xlabel('Radius (mm)', 'fontsize', 16);
ylabel('Scattering angle (degree)', 'fontsize', 16);

saveas(gcf, '../img/lee_000-010.png');
